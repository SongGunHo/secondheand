    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.formLogin(c -> {
            c.loginPage("/member/login")
                    ...
                    .failureHandler(new org.koreait.member.services.LoginFailureHandler());
        });
        ...
        http.exceptionHandling(c -> {
            c.authenticationEntryPoint(new org.koreait.member.services.MemberAuthenticationExceptionHandler()); // 미로그인 상태에서의 인가 실패에 대한 처리
